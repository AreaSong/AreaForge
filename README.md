...
| 维护与证据收口 | `pnpm maintenance:window:record`、`pnpm maintenance:window:index`、`pnpm maintenance:window:index:validate docs/development/maintenance-window-index.json`、`pnpm attachment:reconciliation:summary:selftest`、`pnpm ops:evidence:bundle`、`pnpm ops:long-term:snapshot`、`pnpm ops:alert:preview`、`pnpm ops:support:bundle-preview`、`pnpm ops:backup-restore:preview` |
