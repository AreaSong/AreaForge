...
| 日常只读运营 | `pnpm ops:handoff --summary`、`pnpm ops:handoff:validate <handoff.json>`、`pnpm ops:status --summary`、`pnpm ops:readiness`、`pnpm ops:readonly-side-effect:selftest`、`pnpm ops:data-integrity:selftest`、`pnpm residuals:review-due`、`pnpm residuals:closure:validate <record>` |
