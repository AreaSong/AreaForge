...
- 仓库候选版本：`0.1.7`；线上基线仍是已通过签名 GitHub Release `v0.1.5` 更新到 [forge.areasong.top](https://forge.areasong.top/) 的 `0.1.5`。
...
| 仓库当前重点 | `v0.1.5` 线上基线之后，OPS-001 生产只读 smoke 证据已到 `ready_for_human_close`，当前 release 工作集中在 `v0.1.7` 签名 Release 的 SBOM/provenance 证据；这些仓库能力不能自动等同于线上已更新 |
