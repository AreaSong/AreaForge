...
const focusEvidenceFormsSource = `${readFileSync("apps/web/components/focus-evidence-forms.tsx", "utf8")}\n${readFileSync("apps/web/components/focus-evidence-note-form.tsx", "utf8")}\n${readFileSync("apps/web/components/focus-evidence-mistake-form.tsx", "utf8")}\n${readFileSync("apps/web/components/focus-evidence-form-helpers.tsx", "utf8")}`;
