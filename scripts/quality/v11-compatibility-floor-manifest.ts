...
const currentEntries = [
  ...
  ["20260818090000_v11_mistake_v2", "938f34771dcee285659e2bd2fa03aa6041eb73c2e569258effc25d7f2d6a562b"],
] as const;
...
const expectedManifestDigests = {
  ...
  current: "02c52efde17cd492c1192d9c130fdb929f23e1284e0d143af6690132a55c6990",
} as const;
...
export function assertEmbeddedMigrationManifests(): void {
  ...
  assert.equal(currentMigrationManifest.length, 36);
