...
function testV11EvidenceOnlySurface(): void {
  ...
  const allowedText = [
    ...
    "output/v11-compatibility/compatibility-floor-runtime-v1.1.1-20260731.json",
    "output/supply-chain/ci-supply-chain-v1.1.0-20260727.txt",
    "output/supply-chain/ci-supply-chain-v1.1.1-20260731.txt",
    "output/supply-chain/sc004-main-protection-readback-v1.1.0-20260727.json",
    "output/supply-chain/sc004-main-protection-readback-v1.1.1-20260731.json",
    "output/supply-chain/sc004-controlled-pr-v1.1.0-20260727.json",
    "output/supply-chain/sc004-controlled-pr-v1.1.1-20260731.json",
  ...
  const denied = [
    ...
    "output/supply-chain/ci-supply-chain-v1.2.1-20260727.txt",
