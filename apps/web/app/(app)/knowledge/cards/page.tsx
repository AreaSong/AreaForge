...
export default async function KnowledgeCardsPage({ searchParams }: { searchParams: Promise<{ subjectId?: string; syllabusNodeId?: string; taskId?: string; mastery?: string; review?: string; create?: string; q?: string }> }) {
  ...
  return (
    <div className="space-y-4">
      <h1 data-ai-current-object="true" data-ai-selectable data-ai-label="笔记与卡片" className="text-xl font-semibold text-white">笔记与卡片</h1>
