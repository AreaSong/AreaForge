...
export default async function ReportHistoryPage({
  ...
  const historyHref = `/review/reports/history/${decision.id}?period=${period}`;
  ...
  return (
    <PageFrame variant="content-focus">
      <PageHeader
        ...
        back={(
          <BackToListLink fallbackHref={`/review/reports?tab=history&period=${period}`} className="inline-flex items-center gap-2 text-sm text-teal-300">
