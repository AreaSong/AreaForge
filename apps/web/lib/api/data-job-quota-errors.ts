import type { DataJobQuotaErrorCode } from "@areaforge/core";

const feedback: Record<DataJobQuotaErrorCode, { status: number; message: string }> = {
...
function quotaFeedback(code?: string) {
  return code && Object.hasOwn(feedback, code) ? feedback[code as DataJobQuotaErrorCode] : undefined;
}
