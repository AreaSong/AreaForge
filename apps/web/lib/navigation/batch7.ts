...
export const KNOWLEDGE_TAB_ITEMS = [
  ...
  { href: "/knowledge/cards", label: "笔记与卡片" },
...
const REGISTERED_ROUTES: readonly RegisteredRoute[] = [
  ...
  { pattern: /^\/knowledge\/cards$/, title: "笔记与卡片", returnQueryKeys: ["subjectId", "syllabusNodeId", "taskId", "q", "mastery", "review"] },
  { pattern: /^\/knowledge\/cards\/[^/]+$/, title: "笔记与卡片详情", returnQueryKeys: ["returnTo"] },
