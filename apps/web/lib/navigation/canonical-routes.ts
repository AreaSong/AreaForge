export type AppWorkbenchId = "focus" | "today" | "knowledge" | "test" | "roadmap" | "confirmations" | "settings";
...
export const CANONICAL_ROUTES = [
  ...
  appRoute("/roadmap/allocation/drafts/[itemId]", "投入草稿详情", "roadmap", "content", "content-focus", "/roadmap/allocation/drafts", {
    secondary: "allocation",
    returnQueryKeys: ["returnTo"],
  }),
  appRoute("/roadmap/allocation/tasks/[taskId]", "行动详情", "roadmap", "content", "content-focus", "/roadmap/allocation", {
    secondary: "allocation",
    returnQueryKeys: ["returnTo"],
  }),
  ...
  appRoute("/roadmap/reviews/history/[decisionId]", "冻结报告", "roadmap", "content", "content-focus", "/roadmap/reviews", {
    secondary: "reviews",
    returnQueryKeys: ["period"],
  }),

  appRoute("/test", "检验中心", "test", "secondary", "dashboard-wide", "/test/retests"),
  appRoute("/test/retests", "专项复测", "test", "secondary", "dashboard-wide", "/test/retests", { secondary: "retests" }),
  appRoute("/test/retests/new", "安排专项复测", "test", "content", "content-focus", "/test/retests", {
    secondary: "retests",
    returnQueryKeys: ["returnTo"],
  }),
  appRoute("/test/retests/[retestId]", "专项复测详情", "test", "content", "content-focus", "/test/retests", {
    secondary: "retests",
    returnQueryKeys: ["returnTo"],
  }),
  appRoute("/test/simulations", "模拟考试", "test", "secondary", "dashboard-wide", "/test/retests", { secondary: "simulations" }),
  appRoute("/test/simulations/[examId]", "模拟考试详情", "test", "content", "dashboard-wide", "/test/retests", {
  ...
  appRoute("/knowledge/reviews/[scheduleId]/run", "快速复习", "knowledge", "content", "workspace-full", "/knowledge", {
    secondary: "reviews",
    returnQueryKeys: ["returnTo"],
  }),
  appRoute("/knowledge", "知识工作台", "knowledge", "secondary", "dashboard-wide", "/knowledge", { secondary: "overview" }),
  ...
  appRoute("/knowledge/points/[pointId]", "知识点详情", "knowledge", "content", "content-focus", "/knowledge", {
    secondary: "points",
    returnQueryKeys: ["returnTo"],
  }),
  ...
  appRoute("/knowledge/imports/[importId]", "导入批次", "knowledge", "content", "dashboard-wide", "/knowledge", { returnQueryKeys: ["returnTo"] }),
  appRoute("/knowledge/syllabi", "考纲", "knowledge", "secondary", "split-view", "/knowledge", {
    secondary: "syllabi",
    returnQueryKeys: ["subjectId", "q", "status", "map", "action"],
  }),
  appRoute("/knowledge/syllabi/[nodeId]", "考纲节点详情", "knowledge", "content", "content-focus", "/knowledge", {
    secondary: "syllabi",
    returnQueryKeys: ["returnTo"],
  }),
  ...
  appRoute("/knowledge/cards/[noteId]", "知识卡片详情", "knowledge", "content", "content-focus", "/knowledge", {
    secondary: "cards",
    returnQueryKeys: ["returnTo"],
  }),
  ...
  appRoute("/knowledge/resources/[resourceId]/preview", "资料预览", "knowledge", "content", "workspace-full", "/knowledge", {
    secondary: "resources",
    returnQueryKeys: ["returnTo"],
  }),
  appRoute("/knowledge/resources/[resourceId]", "资料详情", "knowledge", "content", "content-focus", "/knowledge", {
    secondary: "resources",
    returnQueryKeys: ["returnTo"],
  }),
  ...
  appRoute("/knowledge/reviews/[scheduleId]", "复习排期详情", "knowledge", "content", "content-focus", "/knowledge", {
    secondary: "reviews",
    returnQueryKeys: ["returnTo"],
  }),

  appRoute("/settings", "设置总览", "settings", "secondary", "dashboard-wide", "/settings", { secondary: "overview" }),
