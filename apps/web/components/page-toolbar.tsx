...
export function PageToolbar({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <div
      className="flex min-h-14 min-w-0 shrink-0 flex-wrap items-center gap-x-3 gap-y-2 border-b border-white/10 bg-[var(--af-canvas)]/75 backdrop-blur-md px-4 py-2 sm:flex-nowrap sm:px-6 xl:px-8"
