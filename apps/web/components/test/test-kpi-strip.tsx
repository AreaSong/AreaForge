...
export function TestKpiStrip({ kpis, className = "" }: TestKpiStripProps) {
  ...
  return (
    <div className={`grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5 ${className}`.trim()}>
      {/* 1. 模考场次 */}
      <Card
        variant="master"
      ...
      <Card
        variant="master"
        className="col-span-2 sm:col-span-1 p-3.5 bg-[#0e1619]/90 border border-white/10 transition-all hover:border-white/20"
      >
        <div className="flex items-center justify-between gap-2">
