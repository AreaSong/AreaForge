...
- A -> B 当前进度：v1.3 动态个人版已由 PR #56 合并 `main` commit `40f1b36780418bbd544aaaadcd29c385aa2154e8`，尚缺独立 Release/production disposition；v1.4 AUTH 本地实施已确认，身份、Workspace 与 Membership 主体代码和隔离 PostgreSQL runtime 已形成，默认多人开关关闭，仍缺最终浏览器/总门禁、Git 检查点、Release 和生产证据。v1.5 RBAC 及以后尚未开始。
