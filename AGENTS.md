...
- 下一产品主线：学习行动中心（`workflow/versions/v1.1-learning-action-center.md`），隔离分支 `codex/v1.1-learning-action-center`；S0–S2 与 Batch 3–8（Migration 1–7 / workspace-inbox / 学习树 preview+confirm / StudyResource / 统一复习+CheckIn v2 / App Shell+今日行动中心 / 知识工作台与关联画布）已落地；Batch 9–11 已拆任务；`AF-RISK-DATA-001` 生命周期已接受、residual 保持 deferred-work 未关。阶段索引见 `docs/development/v11-phase-packages.md`。
