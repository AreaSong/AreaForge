...
- 仓库发布候选版本为 `0.1.8`；远端 `https://forge.areasong.top/` 仍通过 GitHub Release `v0.1.7` 签名运行 `0.1.7`，尚未创建或部署 `v0.1.8`。`v0.1.8` 发布候选计划已于 2026-07-20 搁置，当前推进 `workflow/versions/optimization-20260720-long-term-operations.md` 长期运营优化轮。
