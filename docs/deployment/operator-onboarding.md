...
7. 若本次 Release 用于关闭供应链残余项，填写 `docs/development/release-supply-chain-record-template.md`，同时配置 record/assets 运行 `pnpm sc:sc-002:preflight`，再运行 `pnpm release:supply-chain:validate <record> <release-assets-dir> --strict`。
