...
| AF-RISK-OPS-008 | deferred-work | 2026-08-15 | 本地已完成 root-only phase journal 与 hold/drain 实施，并通过临时目录 kill-point/锁竞争 selftest（local_verified）。生产 timer/hold/apply、签名 Release 与 residual 关闭仍未证明 | 否 | 匹配签名 Release 后，独立生产确认完成 timer/hold/drain、admission barrier、崩溃后 fail-closed 与 decision-history reconciliation 证据；Web runtime 不获得控制权 | `tasks/active/0022-updater-phase-journal-hold.md`、OPS-008-PREFLIGHT-CONTRACT-V2 local_verified、临时目录 runtime record、shellcheck、updater preflight、匹配签名 Release 和独立生产部署证据 | `areaforge-sre-ops` / `areaforge-observability` / `areaforge-security-governance` |
