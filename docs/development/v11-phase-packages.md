...
| S5 完整 minor | 11 | `tasks/active/0035-v11-batch11-minor-release.md` | `v1.1.0` admission、Release 与 production apply 已完成；发布后产品化修复、生产数据收口、22/22 入口复验、current-bound admission、稳定 `v1.1.1` Release 与受控 production apply 已完成 | 保持 `AREAFORGE_AUTO_APPLY=none`；不自动改变 residual 状态 |
...
- Batch 11 历史候选已形成 `v1.1.0` Release 并进入生产；发布后修复已通过受保护 PR #27/#28 合并并形成稳定 `v1.1.1` Release，admission、供应链和体验证据均绑定 commit `f995310e30c41270ee1e0a1c1ceeae9b6a8017eb`。2026-08-01 已完成 Web 受控 production apply，更新后 Web/PostgreSQL healthy、migration 24/24、health/extra smoke PASS、journal clean；residual 状态不自动变化。
