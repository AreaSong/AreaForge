...
| `docs/development/operational-readiness.md`、`docs/development/production-smoke-alerting-strategy.md`、`docs/development/residual-risk-ledger.md`、`docs/development/residual-risk-ledger.json`、`scripts/quality/ops-readiness-preflight.ts`、`scripts/quality/residual-ledger-validate.ts`、`scripts/ops/operational-readiness-summary.ts`、`scripts/ops/operational-evidence-bundle.ts`、`scripts/ops/operational-alert-preview.ts` | `pnpm ops:readiness`，`pnpm residuals:validate`，`pnpm ops:readiness:summary`，`pnpm ops:evidence:bundle`，`pnpm ops:alert:preview`，`pnpm docs:readiness`，`git diff --check` |
