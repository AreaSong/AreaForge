...
| `SUPPORT.md`、`.github/ISSUE_TEMPLATE/**`、`docs/development/support-intake.md`、`scripts/quality/support-intake-preflight.ts` | `pnpm support:intake:preflight`，`pnpm governance:preflight`，`pnpm docs:readiness`，`git diff --check` |
