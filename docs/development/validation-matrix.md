...
| `docs/development/completion-evidence-checklist.md`、`docs/development/runtime-write-boundary.md` | `pnpm docs:readiness`，`pnpm risk:preflight`，`pnpm ops:readiness`，`pnpm skills:validate`，`git diff --check`；若改变 release/update 口径，补跑 `pnpm release:train:preflight` |
