...
- Ops readiness or residual ledger: `pnpm ops:readiness`, `pnpm ops:readiness:summary`, `pnpm ops:evidence:bundle`, `pnpm docs:readiness`, `git diff --check`; add release/updater gates when release workflow or updater trust changed.
