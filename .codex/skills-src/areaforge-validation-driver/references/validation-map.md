...
- Ops readiness or residual ledger: `pnpm ops:readiness`, `pnpm docs:readiness`, `git diff --check`; add release/updater gates when release workflow or updater trust changed.
