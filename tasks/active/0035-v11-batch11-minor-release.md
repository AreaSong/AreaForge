...
`v1.1.2` 已于 2026-08-11 形成稳定 GitHub Release，workflow run `31459420245` 成功，签名资产与不可变镜像 digest 已严格验证。任务继续保持 active 仅用于承接未来独立确认的 production apply；当前生产和回滚目标均为 `v1.1.1`。
