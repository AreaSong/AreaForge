...
- 学习行动中心阶段包见 `docs/development/v11-phase-packages.md`；Batch 0 任务 `tasks/active/0025-v11-batch0-doc-sync.md`，Batch 3–7 已完成见 `tasks/done/0027-*` 至 `0031-*`，其余 Batch 1–2/8–11 为 `tasks/backlog/0026-*` 与 `0032-*` 至 `0035-*`。
