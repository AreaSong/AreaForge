...
- A -> B 平台演进由 `tasks/active/0038-platform-evolution-m0.md` 收口 M0，`tasks/active/0039-personal-dynamic-foundation.md` 已进入 v1.3 本地实现；`0040` 至 `0043` 仍在 backlog，分别承接多用户/RBAC、数据生命周期、受控运维、挑战排名和 v2.0 平台门禁。任务进入 active 或总体目标获同意都不等于已经获得 migration、生产写入或数据删除授权。
