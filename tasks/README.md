...
- 学习行动中心阶段包见 `docs/development/v11-phase-packages.md`；Batch 0 任务 `tasks/active/0025-v11-batch0-doc-sync.md`，Batch 3–10 已完成见 `tasks/done/0027-*` 至 `0034-*`，`v1.1.0` 已发布并进入生产，Batch 11 当前在 `tasks/active/0035-v11-batch11-minor-release.md` 收拢 package version `1.1.1` 的发布后修复候选，Batch 1–2 历史复核入口保留在 `tasks/backlog/0026-*`。
