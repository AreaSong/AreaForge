...
- A -> B 平台演进由 `tasks/active/0038-platform-evolution-m0.md` 先收口 M0；后续 `0039` 至 `0043` 分别承接个人动态化、多用户/RBAC、数据生命周期、受控运维、挑战排名和 v2.0 平台门禁。后续任务处于 backlog 不等于已经获得 migration、生产写入或数据删除授权。
