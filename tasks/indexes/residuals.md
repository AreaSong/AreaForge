...
| AF-RISK-OPS-002 | 写入型生产 smoke 策略未定义，不能污染真实学习数据 | `areaforge-qa-smoke` / `areaforge-security-governance` | 设计生产写入 smoke 前 |
...
| AF-RISK-OPS-004 | metrics dashboard / 告警路由未产品化，生产健康依赖 runbook | `areaforge-observability` | 建立告警或声称完整生产健康前 |
