...
|---|---|---|---|
| AF-RISK-OPS-001 | 生产 extra smoke 未配置时，发布体验验证只能到 `warn`；`pnpm smoke:prod-readonly:validate` 可校验 redacted 记录 | `areaforge-sre-ops` / `areaforge-qa-smoke` | 每次 release/update 后 |
