...
| AF-RISK-DATA-003 | v1.8 本地候选已有 scoreVersion/opt-in/挑战 CRUD/反作弊规则/投影/专用持久申诉/成员与 Owner 申诉 UI/独立投影开关/删除预览，以及隔离 fixture 和桌面/移动申诉旅程证据；通知、删除/导出联动、完整浏览器矩阵和生产证据仍缺，保持 deferred-work | `areaforge-product-experience` / `areaforge-security-governance` | RANKING 确认包和 v1.8 前置完成后 |
