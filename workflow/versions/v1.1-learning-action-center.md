...
- 当前版本状态：最新稳定 GitHub Release 与生产基线均为 `v1.1.1` / commit `f995310e30c41270ee1e0a1c1ceeae9b6a8017eb`。2026-08-01 已通过 Web 版本中心提交受控请求并由服务器侧 updater 完成 apply。
- 当前候选状态：`main` 正在准备 `v1.1.2` 签名 Release；候选必须重采 current-bound browser、accessibility、compatibility、SC-002 与 SC-004 证据，本次不执行 production apply。
