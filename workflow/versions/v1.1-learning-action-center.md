...
- 计划状态：**S0–S2 已落地阶段包；S1 Batch 0 文档与任务拆分完成；S3–S5 仅完成任务拆分，业务代码尚未实施**。
...
- 当前实现边界：本文件记录未来版本规格与阶段推进状态，不表示新应用壳、考试工作区、自定义科目、科目快捷计时、统一复习、计划收件箱、学习树版本导入、关联画布、知识卡片、资料资产、动机内容库、浏览器通知、七天看板、结构化失分条目或对应 API/schema 已经实现。
