...
- 当前生产状态：生产与回滚基线仍为 `v1.1.1` / commit `f995310e30c41270ee1e0a1c1ceeae9b6a8017eb`；本次 `v1.1.2` 发布未执行 production apply。
- 当前可用基线：公网 health 已只读验证 production `1.1.1` 和 verified runtime identity；Web/PostgreSQL healthy、migration 24/24、health/extra smoke PASS、journal clean。`v0.1.9`、`v1.1.0` 及其 OPS/供应链 closeout 只保留历史证据，不能证明当前生产健康。
