...
- 当前继续推进 `versions/v1.1-learning-action-center.md` 的 `v1.1.1` 发布后修复候选：本地实现已完成，但尚未 push、创建修复 Release 或 production apply；SC-002/SC-004 和 browser/compatibility 必须按新目标 commit 重采。
