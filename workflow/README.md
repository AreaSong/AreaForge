...
- `versions/v1.3-v2.0-platform-evolution.md`：A -> B 渐进式平台演进总计划；M0 已完成，v1.3 已合并但未独立 Release/生产；v1.4-v1.8 默认关闭的本地候选已通过总门禁、一次性隔离 runtime 和 commit `5816338` 的 branch push CI run `34021752169`。候选 migration 尚未 apply 到共享测试库或生产，v1.9-v2.0 尚未进入业务 runtime；仍缺完整浏览器矩阵、受保护 PR/合并、Release/生产证据。
