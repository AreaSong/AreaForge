...
- `versions/v1.2-high-density-workbench.md`：高密度专业工作台、Dynamic Island、错题 v2 和 Web 共享治理的 `v1.2.0` 发布候选；当前只授权本地验证、PR、CI 与合并，不授权 tag、Release 或 production apply。
...
- 仓库 package version 为 `1.2.0`；当前处于本地发布准备、PR 与 CI 阶段，尚未创建 `v1.2.0` tag 或 Release，本次不包含 production apply。
